...
begin
 ModalResult := mrOK;
 ShellExecute(0, Nil, PChar('mailto:m-city@mail.ru?subject=Регистрация%20программы%20CТ%20"М-Тест"&body='+
 'Название%20организации:%0A'+
 'Телефон:%0A'+
 'Номер%20и%20дата%20договора%20на%20поставку%20СТ%20"М-Тест":%0AМой%20персональный%20номер:%20'+Personal.Text), Nil, Nil, SW_NORMAL);
end;
